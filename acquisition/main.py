...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QWidget, QDesktopWidget, QShortcut, qApp, QFormLayout,QVBoxLayout, QHBoxLayout, QGridLayout, QSizePolicy, QPushButton, QLabel, QSpinBox, QComboBox)
